...
# @version: 0.1.0
# @file: DCACTrainer_Prostate.py
# @time: 2021/09/13
from nnunet.utilities.to_torch import maybe_to_torch, to_cuda
from torch.cuda.amp import autocast
from nnunet.training.network_training.nnUNetTrainerV2 import nnUNetTrainerV2
import torch
from nnunet.network_architecture.DCAC.DCAC_Prostate import DCAC_Prostate
...
class DCACTrainer_Prostate(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = DCAC_Prostate(self.num_input_channels, self.base_num_features, self.num_classes,
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        keys = data_dict['keys']
        batch_class, cond_encoding = DCAC_encoding_class_for_Prostate(keys, self.output_folder)
